...
//
// Usage:
//   node .codex/scripts/tree-fingerprint.mjs            # print it
//   node .codex/scripts/tree-fingerprint.mjs --expect <sha>   # exit 1 if it differs
//
...
//
//   .codex/tmp/         the Reviewer's own record (it has no Write tool; catalog #201)
//   .codex/worktrees/   other lanes' checkouts
...
const PIPELINE_WRITES = /\.codex\/tmp\/|\.codex\/worktrees\/|docs\/plans\/|docs\/prd\/dag\.html/
